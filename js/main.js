...
preview = () => {
  ...
  content += '<div xmlns="http://www.w3.org/1999/xhtml" style="padding: 10px">';
  content += message;
  content += '</div>';
...
fork = async () => {
  ...
  let message = decodeString.replace('<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><rect width="100%" height="100%" fill="white" /><foreignObject x="0" y="0" width="100%" height="100%"><div xmlns="http://www.w3.org/1999/xhtml" style="padding: 10px">', '')
...
const env = {
  "nft_address": {
    "main": "xxxx",
    "rinkeby": "0xC68a1f403F950B495C5A986e039ac167aDE570DD"
  },
  "etherscan": {
